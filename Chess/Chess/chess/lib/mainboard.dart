...
import 'package:chess/reuseFunctions/funcs.dart';
...
class _MainboardState extends State<Mainboard> {
  ...
  List<int>? enPassantTarget = null; // Coordinates of square where en passant capture is possible
  ...
  List<List<int>> calculaterawmoves(int row, int col, ChessPiece? piece) {
    ...
    switch (piece.name) {
      ...
      default:
        break; // No valid moves for other pieces
    }
